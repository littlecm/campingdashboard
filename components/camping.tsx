    ...
    <div className="flex flex-col min-h-screen bg-muted/40">
      ...
      <main className="flex-1 grid gap-8 p-4 md:gap-12 md:p-10">
        <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">Trip Planner</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">Packing List</CardTitle>
            ...
            <CardContent>
              <div className="grid gap-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="font-medium">Food</div>
                  <div className="flex items-center gap-2">
                    <Input type="number" className="w-24 text-right" defaultValue={150} />
                  </div>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Input type="number" className="w-24 text-right" defaultValue={50} />
                  </div>
                </div>
        ...
        <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Showers</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">Location Tracker</CardTitle>
              ...
              <div className="grid gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="grid gap-1">
                    ...
                    <div>
                      <p>Hey everyone, can't wait for the camping trip! Let's make sure we have everything packed.</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="grid gap-1">
                    ...
                    <div>
                      <p>Great idea, Sarah! I'll bring the guitar so we can sing around the campfire.</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div className="grid gap-1">
                    ...
                    <div>
                      <p>Awesome, can't wait! I'll bring the fishing gear too.</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
